...
// ---------------------------------------------------------------------------------------------------------------------
// [overview]
// 比較した2つの構造体が隣接関係にあるかを確認する（再帰）関数
// ---------------------------------------------------------------------------------------------------------------------
// [params]
// X: &Element - 構造体 1
// Y: &Element - 構造体 2
// R: Relationship - 確認したい隣接関係
// ---------------------------------------------------------------------------------------------------------------------
// [return]
// bool - 隣接関係にあるならtrue
// ---------------------------------------------------------------------------------------------------------------------
pub fn relationship(X: &Structure, Y: &Structure, R: Relationship) -> bool {
